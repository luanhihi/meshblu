...
<form name="maudk" action="" method="post">
  ...
  <table border="1" width="268" cellspacing="1" style="border-collapse: collapse" bordercolor="#C0C0C0">
			...
			<tr>
				...
				<td width="147"><input type="text" name="chucdanh" value="<?php echo $infoUser['chucdanh']?>"></td>
			</tr>
			
			<tr>
				<td><strong>Tên tổ chức:</strong></td>
				<td><input type="text" name="tentc" value="<?php echo $infoUser['tentochuc']?>"></td>
			</tr>
			<tr>
				<td><strong>Tên:</strong></td>
				<td><input type="text" name="ten" value="<?php echo $infoUser['ten']?>"></td>
			</tr>
			<tr>
				<td><strong>Họ đệm:</strong></td>
				<td><input type="text" name="hodem" value="<?php echo $infoUser['hodem']?>"></td>
			</tr>
            <tr>
				<td><strong>Địa chỉ:</strong></td>
				<td><input type="text" name="dc" value="<?php echo $infoUser['diachi']?>"></td>
			</tr>
            
				<td><strong>Mô tả bản thân:</strong></td>
				<td><input name="mota" type="text" value="<?php echo $infoUser['mota']?>" size="24" /></td>
...
<p>
  ...
  <textarea name="ghichu" id="ghichu" cols="30" rows="2" value="<?php echo $infoUser['ghichu']?>" ></textarea>
</p>
