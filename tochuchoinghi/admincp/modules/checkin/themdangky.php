...
<p>
	  ...
	  if(isset($_POST['submit'])){
			  ...
			  if(isset($_POST['submit']))
				{
					...
					if (  ! $chucdanh || ! $tentc || !$ten || !$hodem || !$diachi   || ! $loaive ||!$gala || ! $thanhtoan )
				{
			...
			exit;
				 ...
				 $b=mysql_query("INSERT INTO dangkyhoithao (matv,Maht,chucdanh, tentochuc, ten, hodem, diachi,mota,loaive,galadinner,ghichu,thanhtoan,status)  	   	               VALUES   ('$matv','$mahoinghi','$chucdanh', '$tentc', '$ten','$hodem', '$diachi','$mota', '$loaive' ,'$gala', '$ghichu','$thanhtoan','1') ");
