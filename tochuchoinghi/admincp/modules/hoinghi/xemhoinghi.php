        ...
        <tbody>
          <?php
		   if(isset($_GET['Maht']) && $_GET['Maht'] != null){
             ...
             $sql = "SELECT * FROM dangkyhoithao WHERE Maht ='".$_GET['Maht']."'";
             ...
             if($total > 0){
                while($data = mysql_fetch_assoc($query)){
					...
					//echo "<td>".$total."</td>";
                     echo "<td><a href='index.php?quanly=daibieu&ac=sua&Madk=".$data['Madk']."'>
                                 Edit</a></td>";
                      echo "<td><a href='modules/daibieu/xoadangky.php?Madk=".$data['Madk']."'>
                                 Delete</a></td>";
                      echo "</tr>";
                    }    
                }
